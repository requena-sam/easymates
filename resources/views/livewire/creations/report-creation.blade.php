<div class="space-y-4 sm:space-y-6">
    <h2 class="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">Signaler cette création</h2>
        ...
        <div class="space-y-2">
            ...
            <div class="space-y-2">
                @foreach(\App\Enums\ReportReason::cases() as $reasonCase)
                    <label
                        class="flex items-start gap-2 sm:gap-3 p-2 sm:p-3 border border-gray-300 rounded-xl cursor-pointer hover:bg-gray-50 transition">
                        <input
                            type="radio"
