...
<meta property="og:image" content="{{ asset('storage/images/og-image.png') }}">
<meta property="og:url" content="https://easymate.fr">
...
<meta name="twitter:image" content="{{ asset('storage/images/og-image.png') }}">
