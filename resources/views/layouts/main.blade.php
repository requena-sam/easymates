...
<header
    class="
        flex justify-between items-center py-6 px-5 md:py-0 md:px-0 sticky top-0 z-50 bg-[var(--color-background)]/80 backdrop-blur-sm border-b border-[var(--color-light-grey)]/10
 md:static md:z-auto md:bg-transparent md:backdrop-blur-0 md:border-0 ">
    <img
